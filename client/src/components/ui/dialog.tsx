...
const DialogContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content> & {
    variant?: "default" | "glass" | "neomorphic" | "flat"
  }
  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        variant === "glass" && "bg-background bg-opacity-50 backdrop-blur-sm border border-border border-opacity-50 shadow-sm rounded-lg border-0",
        variant === "neomorphic" && "neumorphism border-0",
        variant === "flat" && "flat-card border-0",
        variant === "default" && "border bg-background shadow-lg",
        className
      )}
      {...props}
    >
